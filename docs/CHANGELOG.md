...
- **Tractor implement default rates** — `vehicle_types.default_rate` + `default_rate_unit` (`hour`/`trip`/`bale`); migration `040` seeds Cultivator ₹1200/hr, Rotavator ₹1440/hr, Trolley ₹250/trip, Baler ₹40/bale, Weeder ₹1000/hr, Fertilizer pump ₹500/hr. Web tractor-work form auto-calculates total from equipment + hours/trips/bales; backend applies when total is zero.
