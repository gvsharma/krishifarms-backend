...
- **Keshampeta mandal village masters** — `scripts/data/rangareddy_service_villages.py` updated to 29 villages/hamlets (EN + `name_te`); `seed_locations` upserts Telugu names; default ops village in `seed_services` is Bhairkhanpalle (Rangareddy).
