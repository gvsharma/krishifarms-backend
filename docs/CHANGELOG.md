...
- **CI import sanity** — remove stale `HamaliWorkEntry` / `Worker` import from `app/models.py` (correct models already imported as `HamaliWorker`, `HamaliDailyEntry`, `HamaliWeeklyPayment`).
