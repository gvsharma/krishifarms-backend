...
- **Supabase pooler host** — project `ucvwtoziiqgmcyzxkwxe` uses `aws-0-ap-northeast-1.pooler.supabase.com` (session pooler); set GitHub variable `SUPABASE_POOLER_HOST`
